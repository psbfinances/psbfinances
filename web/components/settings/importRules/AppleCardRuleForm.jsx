...
/**
 * Rule form for Apple Card transactions.
 * @param {ImportRuleListModel} model
 * @return {JSX.Element|null}
 * @constructor
 */
let AppleCardRuleForm = ({ model }) => {
    ...
    <div id='dataContainer' className='frm formDataContainer'>
      <div id='formContainer' data-testid='formContainer' className='formContainer'>
        ...
        <InputField
          ...
          handleChange={model.handleChange}
          errors={model.formErrors}
          value={model.editItem.condition.Merchant} />
        ...
        <InputField
          ...
          handleChange={model.handleChange}
          errors={model.formErrors}
          value={model.editItem.condition.Type} />
        ...
        <InputField
          ...
          handleChange={model.handleChange}
          errors={model.formErrors}
          value={model.editItem.condition['Amount (USD)']} />
        ...
        <InputField
          ...
          handleChange={model.handleChange}
          errors={model.formErrors}
          value={model.editItem.condition['Purchased By']} />
...
AppleCardRuleForm = observer(AppleCardRuleForm)

export default AppleCardRuleForm
